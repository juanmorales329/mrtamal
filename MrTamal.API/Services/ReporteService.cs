...
public class ReporteService(AppDbContext db)
{
    ...
    // Admin/Gerente sin sucursal = ven todo; con sucursal = su sucursal; resto = solo sus datos
    private static (bool verTodo, int? sucursalId) ResolverVisibilidad(Usuario? usuario)
    {
        ...
        return (esGlobal, usuario.SucursalId);
    }
}
